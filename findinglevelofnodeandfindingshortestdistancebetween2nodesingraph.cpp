...
int main() {
    ...
    do {
        cout << "\nMenu:\n1. Display Adjacency Matrix\n2. Add Edge\n3. BFS Traversal for finding shortest distance between 2 nodes \n6. Find Level of Node\n7. Exit\nEnter your choice: ";
        cin >> choice;
        ...
        case 4:
            ...
            cin >> node;
            int level = graph.bfstraversalforfindinglevelofnode(node);
            if (level != -1) {
                cout << "Level of Node " << node << ": " << level << endl;
            }
            else {
